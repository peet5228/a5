        ...
        <v-row justify="center" align="center">
            <v-col cols="12" md="6" lg="4">
                <v-card elevation="10" rounded="lg" color="#7d0c14">
                    <p class="text-center font-weight-bold text-h5 text-white">NTC EVALUATION SYSTEM</p>
                    ...
                    <v-container class="bg-white">
                        ...
                        <v-form @submit.prevent="Login">
                            ...
                            <v-select v-model="role" :items="g" label="ประเภทสมาชิก" prepend-inner-icon="mdi-lock" />
